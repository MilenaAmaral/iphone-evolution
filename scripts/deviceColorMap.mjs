...
const COLOR_HEX = {
  ...
  'coral': '#f0785a',
  'grafite': '#3f3f3f',
  'azul-pacífico': '#3c5a70',
  'verde-meia-noite': '#425c53',
  'azul-sierra': '#a4b8c4',
  'verde-alpino': '#5d6d5a',
  'roxo-profundo': '#5b4a6e',
  'preto-espacial': '#33322f',
  'prateado': '#d6d6d8',
  'titânio natural': '#8f8a7f',
  'titânio azul': '#4c5a63',
  'titânio branco': '#e4e2d8',
  'titânio preto': '#2b2b2a',
  'titânio deserto': '#b09a76',
  'laranja cósmico': '#c1602f',
  'azul-profundo': '#2e4a63',
  'branco-nuvem': '#ece9e2',
  'dourado-claro': '#e8d9bd',
  'azul-céu': '#a9c6da',
  'céu noturno': '#1c2331',
  'branco estelar': '#ece3d2',
}
